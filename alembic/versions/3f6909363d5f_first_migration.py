...
Revision ID: 3f6909363d5f
Revises: 
Create Date: 2022-06-14 18:47:24.028983
...
def upgrade():
    ...
    with op.batch_alter_table('project', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_project_fully_invested'), ['fully_invested'], unique=False)
...
def downgrade():
    ...
    op.drop_table('user')
    with op.batch_alter_table('project', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_project_fully_invested'))
